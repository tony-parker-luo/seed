...
public class DatePattern {
     ...
     */
//    public static final DateTimeFormatter HTTP_DATETIME_FORMAT = DateTimeFormatter.ofPattern(HTTP_DATETIME_PATTERN, TimeZone.getTimeZone("GMT"), Locale.US);
    ...
    /**
     * UTC时间{@link DateTimeFormatter}：yyyy-MM-dd'T'HH:mm:ss
     */
//    public static final DateTimeFormatter UTC_SIMPLE_FORMAT = DateTimeFormatter.ofPattern(UTC_SIMPLE_PATTERN, TimeZone.getTimeZone("UTC"));
     ...
     */
//    public static final DateTimeFormatter UTC_FORMAT = DateTimeFormatter.ofPattern(UTC_PATTERN, TimeZone.getTimeZone("UTC"));
     ...
     */
//    public static final DateTimeFormatter UTC_WITH_ZONE_OFFSET_FORMAT = DateTimeFormatter.ofPattern(UTC_WITH_ZONE_OFFSET_PATTERN, TimeZone.getTimeZone("UTC"));
     ...
     */
//    public static final DateTimeFormatter UTC_MS_FORMAT = DateTimeFormatter.ofPattern(UTC_MS_PATTERN, TimeZone.getTimeZone("UTC"));
     ...
     * UTC时间{@link DateTimeFormatter}：yyyy-MM-dd'T'HH:mm:ssZ
     */
//    public static final DateTimeFormatter UTC_MS_WITH_ZONE_OFFSET_FORMAT = DateTimeFormatter.ofPattern(UTC_MS_WITH_ZONE_OFFSET_PATTERN, TimeZone.getTimeZone("UTC"));
}
